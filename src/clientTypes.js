...
export type ShortHandFetchOpts = $Diff<FetchOpts, {method?: $PropertyType<FetchOpts, 'method'>}>

export type FetchType = (resource: string, opts?: FetchOpts, internals?: any) => Promise<Response>
export type WrappedFetchType = (resource: string, opts?: FetchOpts, internals: Internals) => Promise<Response>
export type ShortHandFetchType = (resource: string, opts?: ShortHandFetchOpts) => Promise<Response>
