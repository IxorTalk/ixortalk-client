...
import type {FetchOpts, Internals, MethodEnum, ParsedFetchOpts} from '../../clientTypes'
...
const parseOpts = (opts: FetchOpts, internals: Internals): ParsedFetchOpts => {
  ...
  if (opts.body !== null && opts.body !== undefined) {
    if (typeof opts.body === 'object' && Object.getPrototypeOf(opts.body) === Object.getPrototypeOf({})) {
      body = JSON.stringify(opts.body)
      headers = addHeader(headers, 'Content-Type', 'application/json')
    }
    else
      body = validBodyOrNull(opts.body)
  }
...
const withMethod = (opts: FetchOpts = {}, method: MethodEnum): FetchOpts => ({...opts, method})
